...
<html>
    ...
    <head>
        ...
        <script src = "JS/Szukajprodukt.js"></script>
		</head>
    <body>
        ...
        <center>
            <table>
                <tr>
                    ...
                    <td><input type="text" name="ProductId" placeholder="............" onkeyup="getProduct(this.value);"></td>
                </tr>
            </table>
        </center>
        <br/>
        <center><h2>Zobacz Produkty</h2></center>
        <center>
            <table class= "styled-table" border="1" id='ProductList'>
                <tr>
                    <th>ID</th>
                    <th>Nazwa</th>
                    <th>Cena</th>
